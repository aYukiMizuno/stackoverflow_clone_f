...
defmodule StackoverflowCloneF.Controller.Book.IndexRequestParams do
...
defmodule StackoverflowCloneF.Controller.Book.Index do
  ...
  alias StackoverflowCloneF.Controller.Book.{Helper, IndexRequestParams}
