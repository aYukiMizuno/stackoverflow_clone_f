defmodule StackoverflowCloneF.Controller.Book.IndexTest do
  use StackoverflowCloneF.CommonCase
  alias Dodai.RetrieveDedicatedDataEntityListRequestQuery, as: Query
  alias Sazabi.G2gClient
  alias StackoverflowCloneF.Controller.Book.Index
  alias StackoverflowCloneF.Controller.Book.IndexRequestParams
  alias StackoverflowCloneF.TestData.BookData
